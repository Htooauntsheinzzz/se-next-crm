...
const CreateContactModal = dynamic(() => import("@/components/contacts/CreateContactModal").then(m => ({ default: m.CreateContactModal })), { ssr: false });
const EditContactModal = dynamic(() => import("@/components/contacts/EditContactModal").then(m => ({ default: m.EditContactModal })), { ssr: false });
const MergeContactModal = dynamic(() => import("@/components/contacts/MergeContactModal").then(m => ({ default: m.MergeContactModal })), { ssr: false });
const DeactivateContactModal = dynamic(() => import("@/components/contacts/DeactivateContactModal").then(m => ({ default: m.DeactivateContactModal })), { ssr: false });
