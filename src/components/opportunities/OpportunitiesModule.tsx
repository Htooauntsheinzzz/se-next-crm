...
const OpportunityKanbanPage = dynamic(() => import("@/components/opportunities/OpportunityKanbanPage").then(m => ({ default: m.OpportunityKanbanPage })), { ssr: false });
const OpportunityListPage = dynamic(() => import("@/components/opportunities/OpportunityListPage").then(m => ({ default: m.OpportunityListPage })), { ssr: false });
const CreateOpportunityModal = dynamic(() => import("@/components/opportunities/CreateOpportunityModal").then(m => ({ default: m.CreateOpportunityModal })), { ssr: false });
const EditOpportunityModal = dynamic(() => import("@/components/opportunities/EditOpportunityModal").then(m => ({ default: m.EditOpportunityModal })), { ssr: false });
const MarkWonModal = dynamic(() => import("@/components/opportunities/MarkWonModal").then(m => ({ default: m.MarkWonModal })), { ssr: false });
const MarkLostModal = dynamic(() => import("@/components/opportunities/MarkLostModal").then(m => ({ default: m.MarkLostModal })), { ssr: false });
